    ...
    return (
      <button
        ...
        className={cn(
          ...
          "text-foreground font-semibold text-base leading-6",
          "bg-blue-600 hover:bg-blue-700",
          "cursor-pointer overflow-hidden",
          "before:content-[''] before:absolute before:inset-0",
          "before:rounded-[inherit] before:pointer-events-none",
          "before:z-[1]",
          "before:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.2),0_1px_3px_0_rgba(0,0,0,0.30)]",
        ...
        {...props}
        style={{
          "--circle-start": "var(--tw-gradient-from, #60a5fa)",
          "--circle-end": "var(--tw-gradient-to, #1e40af)",
